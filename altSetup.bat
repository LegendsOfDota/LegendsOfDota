...
xcopy /s src\scripts\vscripts alt_dota\game\scripts\vscripts\
::mklink /D /J "alt_dota\game\scripts\kv" "src\scripts\kv"
xcopy /s src\scripts\kv alt_dota\game\scripts\kv\
::mklink /D /J "alt_dota\game\scripts\abilities" "src\scripts\abilities"
xcopy /s src\scripts\abilities alt_dota\game\scripts\abilities\
::mklink /D /J "alt_dota\game\scripts\game_sounds" "src\scripts\game_sounds"
xcopy /s src\scripts\game_sounds alt_dota\game\scripts\game_sounds\
...
xcopy /s src\particles alt_dota\game\particles\


::mklink /D /J "alt_dota\game\resource\flash3" "src\resource\flash3"
xcopy /s src\resource\flash3 alt_dota\game\resource\flash3\
::mklink /D /J "alt_dota\game\resource\overviews" "src\resource\overviews"
xcopy /s src\resource\overviews alt_dota\game\resource\overviews\


::mklink /H "alt_dota\game\resource\addon_english.txt" "script_generator\BIN\addon_english.txt"
xcopy script_generator\BIN\addon_english.txt alt_dota\game\resource\
...
xcopy /s src\materials alt_dota\game\materials\